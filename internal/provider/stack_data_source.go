		...
		Attributes: map[string]schema.Attribute{
			...
			"azure": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"runner_nested_template_url": schema.StringAttribute{Computed: true, MarkdownDescription: "ARM template the app declares for the runner. Empty means use the module's runner."},
			...
			"aws": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"runner_nested_template_url": schema.StringAttribute{Computed: true, MarkdownDescription: "CloudFormation template the app declares for the runner. Empty means use the module's runner."},
